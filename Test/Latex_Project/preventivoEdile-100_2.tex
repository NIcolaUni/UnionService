                        ...
                        \end{spacing} \\ \hline %FINE RIGA
                            ...
                            DEMOLIZIONI                    
                                 ...
                                 \hline
                            \vspace{2.5mm}\begin{spacing}{0}1\end{spacing} &\vspace{2.5mm}\begin{spacing}{0}ciao\end{spacing} &\vspace{2.5mm}\begin{spacing}{0}-\end{spacing} &\vspace{2.5mm}\begin{spacing}{0}a corpo\end{spacing} &\vspace{2.5mm}\begin{spacing}{0}\euro\hfill  67.0
                         \end{spacing} \\ \hline %FINE RIGA

                         \vspace{2.5mm}\begin{spacing}{0}\end{spacing} &\vspace{2.5mm}\begin{spacing}{0}Assistenza: \newline ooka\end{spacing} &\vspace{2.5mm}\begin{spacing}{0}\end{spacing} &\vspace{2.5mm}\begin{spacing}{0}\end{spacing} &\vspace{2.5mm}\begin{spacing}{0}\euro\hfill  35.0
                                 \end{spacing} \\ \hline %FINE RIGA

                                 \vspace{2.5mm}\begin{spacing}{0}2\end{spacing} &\vspace{2.5mm}\begin{spacing}{0}cna\end{spacing} &\vspace{2.5mm}\begin{spacing}{0}-\end{spacing} &\vspace{2.5mm}\begin{spacing}{0}a corpo\end{spacing} &\vspace{2.5mm}\begin{spacing}{0}\euro\hfill  96.8
                         \end{spacing} \\ \hline %FINE RIGA

                         \vspace{2.5mm}\begin{spacing}{0}\end{spacing} &\vspace{2.5mm}\begin{spacing}{0}Assistenza: \newline evviva\end{spacing} &\vspace{2.5mm}\begin{spacing}{0}\end{spacing} &\vspace{2.5mm}\begin{spacing}{0}\end{spacing} &\vspace{2.5mm}\begin{spacing}{0}10.0 \%
                                 \end{spacing} \\ \hline %FINE RIGA
                            ...
                            SOLAIO                    
                                 ...
                                 \hline
                            \vspace{2.5mm}\begin{spacing}{0}3\end{spacing} &\vspace{2.5mm}\begin{spacing}{0}bhbkb\end{spacing} &\vspace{2.5mm}\begin{spacing}{0}-\end{spacing} &\vspace{2.5mm}\begin{spacing}{0}a corpo\end{spacing} &\vspace{2.5mm}\begin{spacing}{0}\euro\hfill  0.0
                         \end{spacing} \\ \hline %FINE RIGA

                         \vspace{2.5mm}\begin{spacing}{0}\end{spacing} &\vspace{2.5mm}\begin{spacing}{0}Assistenza: \newline No assistenza\end{spacing} &\vspace{2.5mm}\begin{spacing}{0}\end{spacing} &\vspace{2.5mm}\begin{spacing}{0}\end{spacing} &\vspace{2.5mm}\begin{spacing}{0}-
                                 \end{spacing} \\ \hline %FINE RIGA
