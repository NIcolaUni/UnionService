                              ...
                              \rhead{US101PAN19E}
                               ...
                               NICOLA CHILELLI \newline tel. 3511610715 \newline VIA MONTE PASTELLO, 41 OSPEDELETTO
                                  ...
                                  \vspace{2.5mm}
                                  \begin{spacing}{0}
                                \textbf{Preventivo Edile - } \textcolor{red}{revisione n.3}
                                  \end{spacing}&
                                  \vspace{2.5mm}
                                  \begin{spacing}{0}
                        ...
                        \end{spacing} \\ \hline %FINE RIGA
                            ...
                            PRATICHE                    
                                 ...
                                 \hline
                            \vspace{2.5mm}\begin{spacing}{0}3\end{spacing} &\vspace{2.5mm}\begin{spacing}{0}Pratica progettuale per detrazione fiscale. Escluse eventuali post accesso agli atti in comune e spese di segreteria a discrezione del comune stesso.\end{spacing} &\vspace{2.5mm}\begin{spacing}{0}-\end{spacing} &\vspace{2.5mm}\begin{spacing}{0}a corpo\end{spacing} &\vspace{2.5mm}\begin{spacing}{0}\euro\hfill  560.0
                         \end{spacing} \\ \hline %FINE RIGA
