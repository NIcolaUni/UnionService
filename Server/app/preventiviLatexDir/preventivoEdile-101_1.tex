                        ...
                        \end{spacing} \\ \hline %FINE RIGA
                         ...
                         \vspace{2.5mm}\begin{spacing}{0}6\end{spacing} &\vspace{2.5mm}\begin{spacing}{0}Demolizione pavimentazione in sovrapposizione su corridoio notte, corridoio giorno, sala e cucina. ( senza deteriorare il fondo).\end{spacing} &\vspace{2.5mm}\begin{spacing}{0}-\end{spacing} &\vspace{2.5mm}\begin{spacing}{0}a corpo\end{spacing} &\vspace{2.5mm}\begin{spacing}{0}\euro\hfill  720.0
                         \end{spacing} \\ \hline %FINE RIGA
                         ...
                         \vspace{2.5mm}\begin{spacing}{0}\end{spacing} &\vspace{2.5mm}\begin{spacing}{0}Assistenza: \newline Assistenza\end{spacing} &\vspace{2.5mm}\begin{spacing}{0}\end{spacing} &\vspace{2.5mm}\begin{spacing}{0}\end{spacing} &\vspace{2.5mm}\begin{spacing}{0}0.0 \%
                                 \end{spacing} \\ \hline %FINE RIGA
                        ...
                        \end{spacing} \\ \hline %FINE RIGA
                         ...
                         \end{spacing} \\ \hline %FINE RIGA
                            ...
                            TRASPORTO MATERIALI                    
                                 ...
                                 \hline
                            \vspace{2.5mm}\begin{spacing}{0}12\end{spacing} &\vspace{2.5mm}\begin{spacing}{0}Trasporto materiali da piano terra a piano di lavoro con scala esterna mobile o montacarichi. Noleggio e trasporto incluso.\end{spacing} &\vspace{2.5mm}\begin{spacing}{0}-\end{spacing} &\vspace{2.5mm}\begin{spacing}{0}a corpo\end{spacing} &\vspace{2.5mm}\begin{spacing}{0}\euro\hfill  320.0
                         \end{spacing} \\ \hline %FINE RIGA
