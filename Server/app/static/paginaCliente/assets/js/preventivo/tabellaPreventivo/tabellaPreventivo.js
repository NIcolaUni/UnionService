class TabellaPreventivo extends ElementoTabella{
    ...
    constructor(nomiColonna, intestazioneSettore, grandezzeCelle, listaColonneVisibili, oggettoGeneratore){
        /*
        ...
        */
        super( $('<table id="bodyPreventivo"></table>'), oggettoGeneratore)
